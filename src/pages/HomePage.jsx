...
const BodyContent = () => {
  return (
    <div style={{ paddingLeft: '100px', paddingTop:'50px',fontSize: '2.5rem' }}>
      ...
      <p style={{ paddingLeft:'20px',fontSize: '1rem' }}>"Esta es la página de solicitud de pasantía. Desde aquí, puede ir a las siguientes páginas dando click en los siguiente enlaces:</p>
